package com.saitawngpha.securityapp.screen
...
import com.saitawngpha.securityapp.util.KeyPairHandler
import com.saitawngpha.securityapp.util.RequestState
...
class MainViewModel @Inject constructor(
    ...
    private val keyProviderServices: KeyProviderServices
): ViewModel() {

    private var _apiKeysReady: MutableState<RequestState<Boolean>> = mutableStateOf(RequestState.Idel)
    ...
    private suspend fun fetchEncryptedApiKeys(publicKey: String): String? {
        val response = keyProviderServices.getEncryptedApiKey(publicKey = publicKey)
